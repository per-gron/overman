 ...
 * @param clock Optional. Function that returns the current time in
 *     milliseconds since an arbitrary but constant point in the past. Mainly
 *     used for testing.
 */
function Summary(stream, clock) {
  this._stream = stream;
...
Summary.prototype.registerTests = function() {
  this._startedAt = this._clock().getTime();
};
...
Summary.prototype._timeSinceStart = function() {
  return this._clock().getTime() - this._startedAt;
};
