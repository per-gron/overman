...
function runTest(softKill, timeoutTimer, childProcess, debugPort, timeout, graceTime, slowThreshold, reporter, testInterfacePath, testInterfaceParameter, testPath, killSubProcesses, attributes) {
...
function runTestWithRetries(softKill, timeoutTimer, childProcess, debugPort, timeout, graceTime, attempts, slowThreshold, reporter, testInterfacePath, testInterfaceParameter, testPath, killSubProcesses, attributes) {
  ...
  return runTest(softKill, timeoutTimer, childProcess, debugPort, timeout, graceTime, slowThreshold, retryingReporter, testInterfacePath, testInterfaceParameter, testPath, killSubProcesses, attributes)
    .then(function() {
    ...
    .catch(function(error) {
      ...
      if (attempts <= 1) {
        ...
        return runTestWithRetries(softKill, timeoutTimer, childProcess, debugPort, timeout, graceTime, attempts - 1, slowThreshold, reporter, testInterfacePath, testInterfaceParameter, testPath, killSubProcesses, attributes);
      }
    });
}
...
function runOrSkipTest(softKill, timeoutTimer, childProcess, debugPort, attempts, globalTimeout, graceTime, globalSlowThreshold, reporter, testInterfacePath, testInterfaceParameter, testDescriptor, killSubProcesses) {
  ...
  if (testDescriptor.skipped) {
    ...
    return runTestWithRetries(softKill, timeoutTimer, childProcess, debugPort, timeout, graceTime, attempts, slowThreshold, reporter, testInterfacePath, testInterfaceParameter, testPath, killSubProcesses, testAttributes);
  }
}
