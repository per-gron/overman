...
function runTestProcess(childProcess, debugPort, timeout, slowThreshold, reporter, testInterfacePath, testInterfaceParameter, testPath, killSubProcesses, attributes) {
  var parameters = {
    timeout: timeout,
...
function runTest(softKill, timeoutTimer, childProcess, debugPort, timeout, graceTime, slowThreshold, reporter, testInterfacePath, testInterfaceParameter, testPath, unstable, killSubProcesses, attributes) {
  var didTimeout = false;
  var child = runTestProcess(childProcess, debugPort, timeout, slowThreshold, reporter, testInterfacePath, testInterfaceParameter, testPath, killSubProcesses, attributes);
...
function runTestWithRetries(softKill, timeoutTimer, childProcess, debugPort, timeout, graceTime, attempts, slowThreshold, reporter, testInterfacePath, testInterfaceParameter, testPath, unstable, killSubProcesses, attributes) {
  ...
  return runTest(softKill, timeoutTimer, childProcess, debugPort, timeout, graceTime, slowThreshold, retryingReporter, testInterfacePath, testInterfaceParameter, testPath, unstable, killSubProcesses, attributes)
    .then(function() {
    ...
    .catch(function(error) {
      ...
      if (attempts <= 1) {
        ...
        return runTestWithRetries(softKill, timeoutTimer, childProcess, debugPort, timeout, graceTime, attempts - 1, slowThreshold, reporter, testInterfacePath, testInterfaceParameter, testPath, unstable, killSubProcesses, attributes);
      }
    });
}

function runOrSkipTest(softKill, timeoutTimer, childProcess, debugPort, attempts, globalTimeout, graceTime, globalSlowThreshold, reporter, testInterfacePath, testInterfaceParameter, testDescriptor, runUnstable, killSubProcesses) {
  ...
  if (testDescriptor.skipped || (unstable && !runUnstable)) {
    ...
    return runTestWithRetries(softKill, timeoutTimer, childProcess, debugPort, timeout, graceTime, attempts, slowThreshold, reporter, testInterfacePath, testInterfaceParameter, testPath, unstable, killSubProcesses, testAttributes);
  }
}
