...
describe('List suite', function () {
  ...
  describe('#listTestsOfFile', function () {
    it('should parse stdout JSON on success', function () {
      var suite = path.resolve(__dirname + '/../../data/suite/suite_single_successful_test');
    ...
    it('should parse attributes', function () {
      var suite = path.resolve(__dirname + '/../../data/suite/suite_single_test_attributes');
      return list(suite).then(function (result) {
        expect(result).to.be.deep.equal([
          {
            path: {
    ...
    it('should parse attributes where test attributes overrides the suite', function () {
      var suite = path.resolve(__dirname + '/../../data/suite/suite_attributes');
      return list(suite).then(function (result) {
        expect(result).to.be.deep.equal([
          {
            path: {
    ...
    it('should report skipped tests as skipped', function () {
      var suite = path.resolve(__dirname + '/../../data/suite/suite_single_skipped_test');
      return list(suite).then(function (result) {
        expect(result).to.be.deep.equal([
          {
            path: {
    ...
    it('should report tests where the suite overrides the timeout', function () {
      var suite = path.resolve(__dirname + '/../../data/suite/suite_timeout_set_in_suite');
      return list(suite).then(function (result) {
        expect(result).to.be.deep.equal([
          {
            path: {
    ...
    it('should report tests where the suite overrides the slowness threshold', function () {
      var suite = path.resolve(__dirname + '/../../data/suite/suite_slow_set_in_suite');
      return list(suite).then(function (result) {
        expect(result).to.be.deep.equal([
          {
            path: {
    ...
    it('should report tests marked as only', function () {
      var suite = path.resolve(__dirname + '/../../data/suite/suite_single_only_test');
      return list(suite).then(function (result) {
        expect(result).to.be.deep.equal([
          {
            path: {
    ...
    it('should report unstable tests as unstable', function () {
      var suite = path.resolve(__dirname + '/../../data/suite/suite_single_unstable_test');
      return list(suite).then(function (result) {
        expect(result).to.be.deep.equal([
          {
            path: {
    ...
    it('should fail with a ListTestError when the listing fails', function () {
      var suite = path.resolve(__dirname + '/../../data/suite/suite_syntax_error');
    ...
    it('should fail with a timed out ListTestError when the listing times out', function () {
      var suite = path.resolve(__dirname + '/../../data/suite/suite_neverending_listing');
